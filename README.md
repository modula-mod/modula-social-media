...
## Social 1.6.2 shell-aligned runtime proof

Social 1.6.2 is the immutable shell-aligned advanced runtime release. It adds visible advanced composer controls, reaction bar counts, comments drawer behavior, share/bookmark actions, profile extension proof, reels compatibility, and module metadata panels for widgets, functions, permissions, notifications, and events.
